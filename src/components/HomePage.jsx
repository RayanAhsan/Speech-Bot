...
export default function HomePage(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20'>
            <h1 className='font-semibold text-5xl sm:text-6xl md:text-7xl'>Speech<span className='text-blue-400 bold'>Bot</span></h1>
            ...
            <p className='italic text-slate-900'>Generate notes on lectures, courses, etc.</p>
        </main>
    )
}
